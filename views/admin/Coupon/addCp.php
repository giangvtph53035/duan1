                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                            <form class="theme-form theme-form-2 mega-form" action="index.php?act=coupon-add" method="post">
                                                <!-- Coupon Name -->
                                                <div class="mb-4 row align-items-center">
                                                    <label class="form-label-title col-lg-2 col-md-3 mb-0">Tên mã giảm giá</label>
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="text" name="name" placeholder="Nhập tên mã giảm giá">
                                                    </div>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control" name="coupon_type">
                                                            ...
                                                            <option value="fixed-Amount">Giảm cố định</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="number" value="0" name="coupon_value" placeholder="Giá trị mã giảm giá">
                                                    </div>
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-md-9 col-lg-10">
                                                        <input class="form-control" type="number" name="quantity" placeholder="Số lượng mã giảm giá">
                                                    </div>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control" name="status">
                                                            ...
                                                            <option value="hidden">Dừng hoạt động</option>
                                                        </select>
                                                ...
                                                <!-- Submit Button -->
                                                <div class="mt-4">
                                                    <button class="btn btn-primary" name="add-coupon" type="submit">Thêm Mã Giảm Giá</button>
                                                </div>
                                            </form>
